...
![](./day02-docker.assets/1750509070191-19.png)
...
![](./day02-docker.assets/1750509070188-1.png)

以及对应的初始化SQL脚本和配置文件：

![](./day02-docker.assets/1750509070188-2.png)

![](./day02-docker.assets/1750509070189-3.png)
...
![](./day02-docker.assets/1750509070189-4.png)
...
![](./day02-docker.assets/1750509070189-5.png)
...
![](./day02-docker.assets/1750509070189-6.png)



首先，我们将课前资料提供的`docker-demo.jar`包以及`Dockerfile`拷贝到虚拟机的`/root/demo`目录：

![](./day02-docker.assets/1750509070189-7.png)
...
![](./day02-docker.assets/1750509070189-8.png)
...
![](./day02-docker.assets/1750509070189-9.png)

我们要部署的就是其中的`hm-service`，其中的配置文件采用了多环境的方式：

![](./day02-docker.assets/1750509070189-10.png)
...
![](./day02-docker.assets/1750509070189-11.png)

这两个变量在`application-dev.yaml`和`application-local.yaml`中并不相同：

![](./day02-docker.assets/1750509070189-12.png)
...
![](./day02-docker.assets/1750509070189-13.png)

结果：

![](./day02-docker.assets/1750509070189-14.png)

将`hm-service`目录下的`Dockerfile`和`hm-service/target`目录下的`hm-service.jar`一起上传到虚拟机的`root`目录：

![](./day02-docker.assets/1750509070189-15.png)
...
![](./day02-docker.assets/1750509070189-16.png)
...
![](./day02-docker.assets/1750509070189-17.png)
...
![](./day02-docker.assets/1750509070189-18.png)
