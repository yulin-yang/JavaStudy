...
<img src="./1.初识算法.assets/image-20221108095747933.png" alt="image-20221108095747933" style="zoom:50%;" />

但随着 $n$ 越来越大，比如说 $n=1000$ 时，用二分查找算法（红色）也就是 $54t$，而蓝色算法则需要 $3003t$

<img src="./1.初识算法.assets/image-20221108100014451.png" alt="image-20221108100014451" style="zoom:50%;" />
...
![image-20221108103846566](./1.初识算法.assets/image-20221108103846566.png)
...
![image-20221108114915524](./1.初识算法.assets/image-20221108114915524.png)
...
![image-20221125174155058](./1.初识算法.assets/image-20221125174155058.png)
