...
![image-20230228090412983](./数据结构与算法.assets/image-20230228090412983.png)
...
![image-20230228091405293](./数据结构与算法.assets/image-20230228091405293.png)
...
![image-20230228144422128](./数据结构与算法.assets/image-20230228144422128.png)
...
![image-20230228152715296](./数据结构与算法.assets/image-20230228152715296.png)
...
![image-20230313090500760](./数据结构与算法.assets/image-20230313090500760.png)

通过旋转可以让树重新变得平衡，并且不会改变二叉搜索树的性质（即左边仍然小，右边仍然大）

![image-20230313090817485](./数据结构与算法.assets/image-20230313090817485.png)
...
![image-20230310153645397](./数据结构与算法.assets/image-20230310153645397.png)

目前此树平衡，当再插入一个 4 时，节点们的高度都产生了相应的变化，8 节点失衡了

![image-20230310153803661](./数据结构与算法.assets/image-20230310153803661.png)

在比如说，下面这棵树一开始也是平衡的

![image-20230310154155728](./数据结构与算法.assets/image-20230310154155728.png)

当删除节点 8 时，节点们的高度都产生了相应的变化，6 节点失衡了

![image-20230310154232729](./数据结构与算法.assets/image-20230310154232729.png)
...
![image-20230310154459709](./数据结构与算法.assets/image-20230310154459709.png)
...
![image-20230310154858754](./数据结构与算法.assets/image-20230310154858754.png)
...
![image-20230310155048187](./数据结构与算法.assets/image-20230310155048187.png)
...
![image-20230310155347349](./数据结构与算法.assets/image-20230310155347349.png)
...
![image-20230310162158692](./数据结构与算法.assets/image-20230310162158692.png)
...
![image-20230310162442932](./数据结构与算法.assets/image-20230310162442932.png)
...
![image-20230310162945078](./数据结构与算法.assets/image-20230310162945078.png)
...
![image-20230310163019508](./数据结构与算法.assets/image-20230310163019508.png)
...
![image-20230310171424362](./数据结构与算法.assets/image-20230310171424362.png)

左子树旋转后

![image-20230310171636904](./数据结构与算法.assets/image-20230310171636904.png)

根右旋前

![image-20230310171821578](./数据结构与算法.assets/image-20230310171821578.png)

根右旋后

![image-20230310171903417](./数据结构与算法.assets/image-20230310171903417.png)
...
![image-20230310172212302](./数据结构与算法.assets/image-20230310172212302.png)

右子树右旋后

![image-20230310172234154](./数据结构与算法.assets/image-20230310172234154.png)

根左旋前

![image-20230310172303012](./数据结构与算法.assets/image-20230310172303012.png)

根左旋后

![image-20230310172317379](./数据结构与算法.assets/image-20230310172317379.png)
...
![image-20230424083655435](./3.基础算法.assets/image-20230424083655435.png)

hash 算法是将任意对象，分配一个**编号**的过程，其中编号是一个有限范围内的数字（如 int 范围内）

![image-20230424090603325](./3.基础算法.assets/image-20230424090603325.png)
...
![image-20230425084247888](./3.基础算法.assets/image-20230425084247888.png)
...
![stability_playing_cards.svg](./数据结构与算法.assets/stability_playing_cards.svg.png)
...
![image-20230504153631958](./数据结构与算法.assets/image-20230504153631958.png)

第二轮冒泡

![image-20230504154044402](./数据结构与算法.assets/image-20230504154044402.png)

未排序区域内就剩一个元素，结束

![image-20230504154213239](./数据结构与算法.assets/image-20230504154213239.png)

优化手段：每次循环时，若能确定**更合适的**右边界，则可以减少冒泡轮数

以数组 3、2、1、4、5 为例，第一轮结束后记录的 x，即为右边界

![image-20230504161136854](./数据结构与算法.assets/image-20230504161136854.png)
...
![image-20230507112728513](./数据结构与算法.assets/image-20230507112728513.png)
...
![image-20230508080820117](./数据结构与算法.assets/image-20230508080820117.png)

交换，下潜调整

![image-20230508080912944](./数据结构与算法.assets/image-20230508080912944.png)

![image-20230508080959301](./数据结构与算法.assets/image-20230508080959301.png)

![image-20230508081052055](./数据结构与算法.assets/image-20230508081052055.png)

![image-20230508081220301](./数据结构与算法.assets/image-20230508081220301.png)

![image-20230508081315265](./数据结构与算法.assets/image-20230508081315265.png)
...
![image-20230513150750673](./数据结构与算法.assets/image-20230513150750673.png)

![image-20230513150907333](./数据结构与算法.assets/image-20230513150907333.png)
...
![image-20230508182439075](./数据结构与算法.assets/image-20230508182439075.png)
...
![image-20230513143854887](./数据结构与算法.assets/image-20230513143854887.png)
...
![image-20230513145045085](./数据结构与算法.assets/image-20230513145045085.png)

i 找到了比基准点大的5，j 找到比基准点小的3，停下来交换

![image-20230513145259217](./数据结构与算法.assets/image-20230513145259217.png)

j 到达right 处结束，right 与 i 交换，一轮分区结束

![image-20230513145454772](./数据结构与算法.assets/image-20230513145454772.png)
...
![image-20230513145918612](./数据结构与算法.assets/image-20230513145918612.png)

i 找到8，j 找到3，二者交换，i 找到7，j 找到2，二者交换

![image-20230513150158220](./数据结构与算法.assets/image-20230513150158220.png)

i == j，退出循环，基准点与 i 交换

![image-20230513150351115](./数据结构与算法.assets/image-20230513150351115.png)
...
![image-20230513152038090](./数据结构与算法.assets/image-20230513152038090.png)
...
![image-20230513151851103](./3.基础算法.assets/image-20230513151851103.png)
